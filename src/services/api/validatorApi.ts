...
export const fetchAllValidators = async () => {
  try {
    ...
    const allValidators = [...current, ...delinquent].map(validator => ({
      name: validator.nodePubkey.slice(0, 6), // Use this as fallback name
    ...
    const knownValidators = [
      ...
      { name: "GenesysGo", votePubkey: "4BXYNuSEqM5HLJYonvgwe2ZLQV1RAGmkZYsG9BV6vYVW", identity: "3xpDCC4XtxAUTgXBHyuNKkzU2HZU3p2NT2XuUWk5LKWr" },
      ...
      { name: "Blockdaemon", votePubkey: "3PdGUBtJK2k1FiMdX3QzEKMYZFcbgn7rGd3QMt5hPuHZ", identity: "EX73A5dC2LRSEGPvpWyeRvVxbH5JM7hf4rkBUxKcT3fj" },
      { name: "Jump Crypto", votePubkey: "D8srGYyKYoXEyXfYHG3SahXjSUJxicFQYZKyXxJ7fGPf", identity: "DmRKm16KZDvSgwSfpPyejiFcQjZJ7N9myDmd7prXzLtY" },
      { name: "Staked", votePubkey: "51JBzSTU5rAM8gLAVQKgp4WoLsNmozTw1GOX39UpsJtU", identity: "5R1aUGVRYYrvkGzcxJJCDVxnB3sMrWcJgAopVi8Vynzc" },
      { name: "Coinbase Cloud", votePubkey: "EH6VQ9oE6HRvxWYeAUG4GiZFpZ3vb7j2fGquAktTsRQJ", identity: "7PdkaCviHKVo8ouPDWYZyt3VxQMxCTo9ZXYnGdKZj8J2" },
      { name: "Binance Staking", votePubkey: "DMqoDi7N76DNS7dN2KYc8jYfY2Jg3VfdQyTMNYTmgX6t", identity: "dHchUWFdQzBTkBqwssCMipNLu8h3zuZh4gXNvqMsX9g" },
      { name: "OKX", votePubkey: "HMU77m6WSL9Xew9YvVCgz1hLuhzamz74eD9avi4XPdr", identity: "11233QaJEMWWJC5VhYL8FeKWu7J7Z3CSZ1WCnB2wUqip" },
      { name: "Kraken", votePubkey: "5NwYJ7pqtAzuJaQHQAhxMZHXG57VTqas3zXxmZQiuE2V", identity: "7VGU4ZwR1e1AFekqbqv2gvjeg47e1PwMPm4BfLtYE8x3" },
      { name: "Anchorage Digital", votePubkey: "4qWoqt71j161Gg4YnYKEGrn5p7MjhLdKzzWmYDBxpwFE", identity: "GgUcGMbFY1FbRCpyMvZajnbfkEkJZgHXYSZwKxUTN7K8" },
      { name: "ShineDAO", votePubkey: "8SQEcP4FaYQySktNQeyxF3w8pvArx3oMEh7fPrzkN9pu", identity: "9NFpWc1TJCne4xnGgJZHmyFNMnMeRkXv4FCAcqTs63W4" },
      { name: "Dokia Capital", votePubkey: "H3GhqPMwvGLdxWg3QJGjXDSkFSJCsFk3Tx9pUTsh2h4W", identity: "dkCNBsnRkZBdQkAgdZxdbwJh6BY6VEK9hmZJ2rLmANv" },
      { name: "Forbole", votePubkey: "AkVoTV59mjJ8r5KNrAFUtUhcH1RZ8Mmd7sDX3jJLxntg", identity: "CHnhV7WR5hJXLQNgvg3rx2TzpSeXmYC8QMkfvxvDQk8t" },
      { name: "Stake.Fish", votePubkey: "D9CfRZohsSL2JhgQFGvRuu5q4wkuj6REu8GoGHYRN8My", identity: "AUgLtpPVvxnmIRUGDLqVGcnsX54gwuJ6JFij6stGECn2" },
      { name: "Alameda Research", votePubkey: "GGiiHefWKXvXAdPwrw1asAKDY1fLcZZ6YGKZQkPYPMPr", identity: "37LWEXHXrCYBKf7S5SkKGrBm9isUhd4DyJ3NCchzWNyF" },
      { name: "Coinlist", votePubkey: "6WL8u9FV3RmwvmWmZ5tTQxYKJ38Cf8RWdBcfnqG6eTXY", identity: "Gj9RdU3AvEBKLmsX3z39Dysso2VThRckvDRTURMyUuE2" },
      { name: "melea", votePubkey: "DRp1Scxvq4ZoNbgHpNNTYVqsEja9jdA9bqUoFG7kWK6B", identity: "6Qr5qJ5sEPW3QymKcPVacKEGkvg1OZQQnEnTHRJkE9Bu" },
      { name: "BL Staking", votePubkey: "EVd8FFVB54svYdZdG6hH4F4hTbqre5mpQ7XyF5rKUmes", identity: "Dm7qJrYWTLvk3dYX7UBCjKPBKpzQTL4wdGpwMNpcNBi2" },
      { name: "Chainflow", votePubkey: "BLVJg8zgQnwVhxrxbRDzwXvcwsKzPLTQYWxo6V7W8jxJ", identity: "3TnVxcBwxASbCmeJ4mYVR7a9h9an94NvTY4RP8KVLCP7" },
      { name: "Stakeconomy", votePubkey: "B24WAtQQyUrY3hLXKUMnCNgMvk9WR8xuU7uMYeJMYWQn", identity: "EYgUfznL7jQ2c3JCXgxc2s2qxsCxw9nxYJ7YVGKBT6R" },
      { name: "mcf", votePubkey: "7mmRxJNttYcJVNsJmiLjTHYmNDt8xn3fQ8JnaNVahKUk", identity: "HWHvQhFmJB3NUcu1aihKmrKegfVxBEHzwVX6yZCKEsi1" },
      { name: "Cosmostation", votePubkey: "9mbQ9mrRjBGiUVnz9Tdf7PuAkWomw3GLZ6Sup3R93Gf8", identity: "7y1f6Mih1gJhrpzPNSMDyTQd12MFQVvecUDHHY5yz2P1" },
      { name: "HashQuark", votePubkey: "FdFYHNCyTJYeJ7MUhyjuSFnUy5RydfyZ6pjx7CDeBYMS", identity: "FiPmNbK38XWzFZhfBzPHRazh689gxZ4gqEDL8qEUQ8YV" },
      { name: "Blockscope", votePubkey: "HrXWqaKF2NJUc5RUowzYJ5yX9y6AeZbJaAZdDtSZ8n6W", identity: "4t9em1dsapgBxhUhUJcKFHgwPJNnWDrNwAGJqqUQmPvY" },
      { name: "01node.com", votePubkey: "DP7V5gZctCzBmf6DqsQXvBYrqWGUBZoufxUKzx5MgMew", identity: "DJv6YQV2tSpi7cMxJ3mCdYx9ySXwK6HdTF5BoXBfWVoW" },
      { name: "Solstake", votePubkey: "49AqLYbpgHHdb3qWyPMAaZmwLVNTNsbxmBgVZdhoBQfF", identity: "GnLdRq6PFC4SX5fPRFbCsQEkUNrHr9mAgVXr1kDMU4qQ" },
      { name: "Wanderer", votePubkey: "BxTUwfMiokzimVDLDupGfVPmWXfLSGVpkGr9TUmetn6b", identity: "BeGmyi98V9U8XrtCVo9KTgLNtnn1TjKmyVKKg7BuWSL" },
      { name: "NTT DATA", votePubkey: "2qvEqds4ZVnkEpbiz8Hq3xt3UjRoGXGEaSKgzqb4D8J9", identity: "3oVexC5D5UwPTECRb142K6nU52HtJx1NHCY7+4aHGH+q" },
      { name: "P2P.ORG", votePubkey: "FC8bhGCso5sJRxGXT5JbMDm7J9KaRvQzSXYMtongBZ33", identity: "6kDyGMHbuGGHvuq71DyqR6V8N4maLBx8pGiA2L2aKv3R" },
      { name: "Kysenpool.io | Staking", votePubkey: "5NH47Zk9NAzfbtqNpUtn8CQgNZeZE88aa2NRpfe7DyTD", identity: "CjhKCjNC1WUgBjAGst3D2XmSsWHvt3zGasasmogPTY6J" },
      { name: "InfStones", votePubkey: "9HSjDs6MBGZrZRJBLnCqrRAVxpwq6JQW3PrBa6qEsTYF", identity: "DbF7QuF8NNWgV3Vj6Z8qaHvZj6QZv9Xm5t3EptfzN76d" },
      { name: "Chorus One", votePubkey: "EoK33UHJHPRodKxaVsU5pKxuGCNiLBW4GK7QKUMpHP9s", identity: "FQsr4BVWy8H1qo3b1Cv79bZ5NcbQwiKeCfbNm9ducpvw" },
      { name: "Chainode Tech (node)", votePubkey: "12oWRNKrW8eXvVxLX7cMHWrnJMqZaZK8gxLNkFgbVf3n", identity: "FHf7WtMZLkNYq7NGGBAF78ZKzKZ7oBbGbAEZR5c6J8eZ" },
      { name: "POS Bakerz", votePubkey: "3SpZRJQcQ4rJynvCGNRBbQjkHGXEMpVsJvTWKvR17gZN", identity: "8c5ZTPGQxEQyZ1Kg7vRGZmQVvAwmRmeGjBPE3VnZjxTh" },
      { name: "Gunstar DAO", votePubkey: "5kgFd4N82ZbX8HpmCpX3kRgLTaBcNTkpmJmzigpzLiS6", identity: "8WwMJ2X5RYvbiXqLaRWv7tQJbJnHWY2LFxsKCVwuTVUc" }
    ];
    
    // Replace any matching validators with the known ones that have proper names
    // and add any known validators that weren't in the initial list
