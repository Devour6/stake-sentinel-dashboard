...
import { Check, AlertTriangle, Server, Clock, Award } from "lucide-react";
        ...
        {isLoading ? (
          ...
          <div className="space-y-4">
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="space-y-2">
                <div className="flex items-center gap-2">
                  <Award className="h-3.5 w-3.5 text-gojira-red" />
                  <span className="text-sm text-muted-foreground">Current Epoch</span>
                </div>
                <p className="font-medium">{validatorInfo.currentEpoch}</p>
              </div>
            </div>
